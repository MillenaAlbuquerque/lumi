...
export interface EntranceResult { result: 'valid' | 'invalid' | 'used'; message: string; ticket_id?: number; movie_title?: string; room_name?: string; seat?: string; used_at?: string }
...
export const entranceService = {
  ...
  validate: (token: string) => request<EntranceResult>('/entrance/validate', {
